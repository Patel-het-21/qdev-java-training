 ...
 * Author      : Het Patel  
 * Date        : 13/10/25  
 * Description : Compare == and .equals() behavior on String, Integer, and BigDecimal objects.
 */
public class EqualsVsDoubleEqualsDemo {
    ...
    */
	public static void main(String[] args) {
		...
		System.out.println("Integer == comparison: " + (num1 == num2));           // false
        System.out.println("Integer .equals() comparison: " + num1.equals(num2)); // true
        ...
        System.out.println("BigDecimal compareTo(): " + num5.compareTo(num6)); // 0
