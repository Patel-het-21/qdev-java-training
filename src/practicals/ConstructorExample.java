 ...
 * Author : Het Patel
 * Date : 11/10/25
 * Description : Program to demonstrate the use of constructors and parameterized constructors with a simple math operation.
 */
public class ConstructorExample {
     ...
     * Assigns the given values to number1 and number2
     *
