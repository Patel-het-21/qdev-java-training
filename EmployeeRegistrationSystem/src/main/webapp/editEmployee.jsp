		...
		<form action="updateEmployee" method="post" class="card p-4 shadow-sm">
			...
			<div class="mb-3">
				<label class="form-label">First Name</label> <input type="text"
					...
					value="${not empty firstName ? firstName : employee.firstName}">
			...
			<div class="mb-3">
				<label class="form-label">Last Name</label> <input type="text"
					...
					value="${not empty lastName ? lastName : employee.lastName}">
			...
			<div class="mb-3">
				<label class="form-label">Username</label> <input type="text"
					...
					value="${not empty userName ? userName : employee.userName}">
			...
			<div class="mb-3">
				<label class="form-label">Password</label> <input type="password"
					...
					value="${not empty password ? password : employee.password}">
			...
			<div class="mb-3">
				<label class="form-label">Contact No</label> <input type="text"
					...
					value="${not empty contactNo ? contactNo : employee.contactNo}">
